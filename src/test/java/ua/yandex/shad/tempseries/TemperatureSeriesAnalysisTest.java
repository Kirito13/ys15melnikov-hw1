...
public class TemperatureSeriesAnalysisTest {
	...
	@Test
	public void testFindTempClosestToZeroWithTheSameAbsValue() {
	...
	@Test
	public void testFindTempClosestToZeroWithZeroElement() {
	...
	@Test
	public void testFindTempClosestToValueWithSameValueElements() {
	...
	@Test
	public void testFindTempClosestToValueWithTheSameTwoAbsValue() {
		double[] temperatureSeries = {7.32, -0.2, 7.48, -1.56, 0.2, -2.8, 6.5};
		TemperatureSeriesAnalysis seriesAnalysis = 
		new TemperatureSeriesAnalysis(temperatureSeries);
